...
from close import kill_running_processes, PRODUCTIVE_APP_LIST 
...
def create_play_list(access_token, song_names):
    ''' 
    ...
    user_id = requests.get("https://community.spotify.com/t5/Spotify-for-Developers/API-Invoke-RestMethod-Only-active-device-shown/td-p/5579880", headers=headers).json()['id']
